  ...
  public:
     ...
     BSTIterator <T> find(T data)
     {
        ...
        for (; it != this->end(); ++it)
        {
           if (*it == data)
           {
              return it;   //return current if value found
           }
        }
        return this->end();//return "end" if value isnt found
     }
};
...
/**********************************************************************
 * deepCopy - Recursive function to copy all nodes in tree
 ***********************************************************************/
template <class T>
void BST<T>::deepCopy(BinaryNode <T> * currentNodeLHS,
              BinaryNode <T> * currentNodeRHS)
{
...
/**********************************************************************
 * noChild - Removing a node with "no" children
 ***********************************************************************/
template <class T>
void BST<T>::noChild(BinaryNode <T> * currentNode)
{
...
/**********************************************************************
 * oneChild - Removing a node with "one" child
 ***********************************************************************/
template <class T>
void BST<T>::oneChild(BinaryNode <T> * currentNode)
{
...
/**********************************************************************
 * twoChild - Removing a node with "two" children
 ***********************************************************************/
template <class T>
void BST<T>::twoChild(BinaryNode <T> * nodeToDelete, BinaryNode <T> * currentNode)
{
   //if the pLeft node of that spot doesnt equal "NULL"
   if (currentNode->pLeft)
   {
 ...
 ***********************************************************************/
template <class T>
void BST<T>::remove(BSTIterator <T> myIt)
{
...
/**********************************************************************
 * remove - removing a certain node
 ***********************************************************************/
template <class T>
void BST<T>::remove(BinaryNode <T> * currentNode)
{
